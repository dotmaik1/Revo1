...
namespace SerialPortListener.Serial
{
    ...
    public class SerialPortManager : IDisposable
    {
        ...
        {
            // TODO Falla al darle click a stop stage, cuando se desconecto el USB de la computadora
            try
            {
                _serialPort.Close();
            }
        ...
        // TODO: algo pasa el momento de cerrar la app sin abrir el puerto serie este simplemente falla de repente
        // Part of basic design pattern for implementing Dispose
        protected virtual void Dispose(bool disposing)
        {
            if (disposing)
            {
                // Se borro esta linea para ver que pedo
                // Quita el evento de serial Sata Received Event Handler de la programacion actual... ?????
                //_serialPort.DataReceived -= new SerialDataReceivedEventHandler(_serialPort_DataReceived);
            }
